...
const TermsOfService = () => {
    return (
        <>
            <Helmet>
                <title>Terms of Service | Skill Tester – AI Mock Interview Platform</title>
                <meta name="description" content="Read the Skill Tester Terms of Service. Learn about your rights and responsibilities when using our AI-powered mock interview platform." />
                <link rel="canonical" href="https://skilltester.app/terms" />
